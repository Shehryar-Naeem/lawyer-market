...
const LawyerDetail = lazy(() => import("./components/Lawyer/details"));
const Gigs = lazy(() => import("./components/Lawyer/gigs"));
const Bid = lazy(() => import("./components/Lawyer/bids"));
const Chat = lazy(() => import("./components/chatComp/chats"));
const UserSetting = lazy(() => import("./pages/userSetting"));
const GigStepOne = lazy(() => import("./pages/createGig/step1"));
const GigStepTwo = lazy(() => import("./pages/createGig/step2"));
const GigStepThree = lazy(() => import("./pages/createGig/step3"));
const EditProfile = lazy(() => import("./components/Lawyer/editProfile"));
const PasswordTab = lazy(() => import("./components/passwordTab"));
const Accounts = lazy(() => import("./components/Accounts"));
const ForgetPassword = lazy(() => import("./pages/forgetPassword"));
const ResetPassword = lazy(() => import("./pages/resetPassword"));
const GetAllGigs = lazy(() => import("./pages/getAllgigs"));
const GigDetail = lazy(() => import("./pages/gigDetail"));
const ClientProfile = lazy(() => import("./pages/clientProfile"));
const ClientPosts = lazy(() => import("./components/client"));
const ChatHome = lazy(() => import("./components/chatComp/subChat/chatHome"));
const UserChat = lazy(() => import("./components/chatComp/subChat/chatby_id"));
const CreateLawyerAccount = lazy(() => import("./pages/createLaywerAccount"));
const CreateLawyerComp = lazy(() => import("./components/createLawyerComp"));
const EditGigStep1 = lazy(() => import("./components/editGig/editGigDetailStep1"));
const EditGigStep2 = lazy(() => import("./components/editGig/editGigStep2"));
const EditGigStep3 = lazy(() => import("./components/editGig/editGigStep3"));
const ClientChat = lazy(() => import("./components/clientchatComp/chats"));
const ClientChatHome = lazy(() => import("./components/clientchatComp/subChat/chatHome"));

const ClientChatById = lazy(() => import("./components/clientchatComp/subChat/chatby_id"));
const CreateClientPost = lazy(() => import("./pages/cleintPost"));
...
const AdminHomePage = lazy(() => import("./pages/dashboard/homePage"));
const ClientPage = lazy(() => import("./pages/dashboard/AllUsers"));
const LawyerPage = lazy(() => import("./pages/dashboard/lawyerPage"));
const GigsPage = lazy(() => import("./pages/dashboard/GigsPage"));

const JobPage = lazy(() => import("./pages/dashboard/JobPage"));
const UpdateGigByAdmin = lazy(() => import("./pages/dashboard/updateGig"));
const UpdateJobByAdmin = lazy(() => import("./pages/dashboard/updateJob"));
